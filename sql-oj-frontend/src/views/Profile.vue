      ...
      <el-card class="stats-card">
        ...
        <div class="stats-grid">
          ...
          <template v-if="!isTeacher">
            ...
            <div class="stat-item">
              <div class="stat-value">{{ stats.solved_count || 0 }}</div>
          ...
          <template v-if="isTeacher">
            <div class="stat-item">
              <div class="stat-value">{{ stats.managed_questions || 0 }}</div>
              <div class="stat-label">管理题目数</div>
            </div>
            <div class="stat-item">
              <div class="stat-value">{{ stats.managed_exams || 0 }}</div>
              <div class="stat-label">管理考试数</div>
            </div>
            <div class="stat-item">
              <div class="stat-value">{{ stats.total_submissions || 0 }}</div>
              <div class="stat-label">系统总提交</div>
            </div>
          </template>
        </div>
...
const loadRecentSubmissions = async () => {
  ...
  try {
    ...
    recentSubmissions.value = (res.data.results || res.data || []).slice(0, 5)
  } catch (error) {
